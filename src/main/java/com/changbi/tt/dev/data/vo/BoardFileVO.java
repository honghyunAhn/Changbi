...
public class BoardFileVO {
	 ...
	 * @param boardFileList
	 */
	public BoardFileVO(int board_file_seq, int board_content_seq, String board_file_saved, String board_file_origin,
			String board_ins_dt, String board_ins_id, String board_udt_dt, String board_udt_id,
			CommonsMultipartFile board_file, List<BoardFileVO> boardFileList) {
		super();
	...
	public void setBoard_file(MultipartFile multipartFile) {
		this.board_file = (CommonsMultipartFile) multipartFile;
	}
