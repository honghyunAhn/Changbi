...
<!-- bootstrap core css -->
<link
	href="<c:url value="/resources/css/ext/bootstrap/bootstrap.min.css"/>"
	rel="stylesheet">
<!-- bootstrap-datetimepicker css -->
<link
	href="<c:url value="/resources/css/ext/bootstrap-datetimepicker/bootstrap-datetimepicker.min.css"/>"
	rel="stylesheet">

<!-- <link href="/resources/css/ext/billboard/billboard.css" rel="stylesheet"> -->

<!-- project css -->
<link href="<c:url value="/resources/css/project/admin/common.css"/>"
	rel="stylesheet" type="text/css">
<link href="<c:url value="/resources/css/project/admin/accordion.css"/>"
	rel="stylesheet" type="text/css">
...
<!-- jQuery -->
<script
	src="<c:url value="/resources/js/ext/jquery/jquery-1.11.0.min.js"/>"></script>
...
<!-- bootstrap -->
<script
	src="<c:url value="/resources/js/ext/bootstrap/bootstrap.min.js"/>"></script>
<!-- bootstrap core javascript -->
<script
	src="<c:url value="/resources/js/ext/bootstrap-datetimepicker/moment.min.js"/>"></script>
<!-- moment javascript -->
<script
	src="<c:url value="/resources/js/ext/bootstrap-datetimepicker/locales.min.js"/>"></script>
<!-- locales javascript -->
<script
	src="<c:url value="/resources/js/ext/bootstrap-datetimepicker/bootstrap-datetimepicker.min.js"/>"></script>
...
<link rel="stylesheet"
	href="/resources/css/project/admin/admin_02_classManagement_style.css">
...
<script type="text/javascript">
	...
	$(document).ready(
			function(e) {
				...
				$(".acc_content li:not(.acc_content li:has(ul))").click(
						function(e) {
	...
	function getDateFormat(timestamp) {
		...
		var formattedVal = year + '-' + month + '-' + day + ' ' + time + ':'
				+ min + ':' + sec;
	...
	function ilist(page) {
		location.href = "/edu/admin/admin_info_setting_form?curPage=" + page
				+ "&pageCount=${map.pageCount}";
	}

	function search_name() {
		var searchName = $("#name").val();
		location.href = "/edu/admin/admin_info_setting_form?searchName="
				+ searchName
				+ "&curPage=${map.adminPager.curPage}&pageCount=${map.pageCount}";
	}

	function sendRequest() {

		var messageDiv = '', $messageDiv = $('#messageDiv');
...
<body style="overflow-y: scroll;">
	<div id="wrap">
		<!-- 레이어 팝업 영역 -->
		<div class="overlay"
			style="display: none; background-color: #000; bottom: 0; left: 0; opacity: 0.5; filter: alpha(opacity = 50); position: fixed; right: 0; top: 0; z-index: 1999;"></div>
		<div class="popup"
			style="width: 800px; height: 600px; position: absolute; box-shadow: 0px 1px 20px #333; display: none; background-color: #fff; z-index: 2000;">
			<div class="popup_title"
				style="width: 800px; height: 40px; background-color: #aaa;"></div>
			<div class="popup_content"
				style="width: 780px; height: 540px; padding: 10px; overflow-y: auto;"></div>
		</div>
		<!--// 레이어 팝업 영역 -->
		...
		<div id="header">
			<div class="header">
				<h1 class="navbar-brand">
					<a class="navbar-brand" href="javascript:mainPageLoad();">창비연수관리자</a>
				</h1>
				<ul class="navbar-top-links">
					<li class="button-dropdown"><c:choose>
						...
						<ul class="dropdown-menu">
							<li><a
								href="javascript:contentLoad('마이페이지','/admin/base/myPage');">내정보</a></li>
		...
		<div class="navbar-sidebar">
			<ul id="my-accordion" class="accordionjs">
				<c:choose>
					<c:when test="${loginUser.grade eq 8 or loginUser.grade eq 9}">
						<li><a href="javascript:void(0);">관리자 설정</a>
							<ul class="acc_content">
								<li><a
									href="javascript:contentLoad('관리자 설정','/admin/adminManagement/adminManagementForm', {'pageNo' : 1, 'numOfRows' : 1});">관리자
										설정</a></li>
								<li><a
									href="javascript:contentLoad('권한 설정 내역','/admin/adminManagement/adminManagementHistory');">권한
										설정 내역</a></li>
							</ul></li>
						<li><a href="javascript:void(0);">수강관리</a>
							<ul class="acc_content">
								<li><a
									href="javascript:contentLoad('개별신청관리','/admin/learnApp/learnAppList');">개별신청관리</a></li>
								<!--	<li><a href="javascript:contentLoad('교육청(기관)신청관리','/admin/learnApp/learnAppList', {'groupLearnYn' : 'Y'});">교육청(기관)신청관리</a></li>-->
								<li><a
									href="javascript:contentLoad('수강관리','/admin/learnApp/learnManList');">수강관리</a></li>
								<!-- 
					...
					-->
								<li><a
									href="javascript:contentLoad('수강취소관리','/admin/learnApp/learnCancelList');">수강취소관리</a></li>
								<li><a
									href="javascript:contentLoad('입과관리','/admin/learnApp/learnAppInsert');">입과관리</a></li>
							</ul></li>

						<li><a href="javascript:void(0);">평가관리</a>
							<ul class="acc_content">
								<li><a href="javascript:void(0);">온라인시험관리</a>
									<ul style="display: none;">
										<li><a
											href="javascript:contentLoad('온라인시험 문제은행관리','/admin/quiz/quizBankList', {'quizType' : '2'});">온라인시험
												문제은행관리</a></li>
										<li><a
											href="javascript:contentLoad('온라인시험 시험지풀관리','/admin/quiz/quizPoolList', {'quizType' : '2'});">온라인시험
												시험지풀관리</a></li>
										<li><a
											href="javascript:contentLoad('기수/과정별 온라인시험 관리','/admin/quiz/quizList', {'quizType' : '2'});">기수/과정별
												온라인시험 관리</a></li>
										<li><a
											href="javascript:contentLoad('기수/과정별 온라인시험 현황','/admin/quiz/quizAppList', {'quizType' : '2'});">기수/과정별
												온라인시험 현황</a></li>
										<!-- <li><a href="javascript:alert('준비중입니다.');">온라인시험 관리 매뉴얼</a></li> -->
									</ul></li>
								<li><a href="javascript:void(0);">온라인과제관리</a>
									<ul style="display: none;">
										<li><a
											href="javascript:contentLoad('온라인과제 문제은행관리','/admin/quiz/quizBankList', {'quizType' : '3'});">온라인과제
												문제은행관리</a></li>
										<li><a
											href="javascript:contentLoad('온라인과제 시험지풀관리','/admin/quiz/quizPoolList', {'quizType' : '3'});">온라인과제
												시험지풀관리</a></li>
										<li><a
											href="javascript:contentLoad('기수/과정별 온라인과제 관리','/admin/quiz/quizList', {'quizType' : '3'});">기수/과정별
												온라인과제 관리</a></li>
										<li><a
											href="javascript:contentLoad('기수/과정별 온라인과제 현황','/admin/quiz/quizAppList', {'quizType' : '3'});">기수/과정별
												온라인과제 현황</a></li>
								...
								<li><a href="javascript:void(0);">출석시험관리</a>
									<ul style="display: none;">
										<li><a
											href="javascript:contentLoad('출석시험 문제은행관리','/admin/quiz/quizBankList', {'quizType' : '1'});">출석시험
												문제은행관리</a></li>
										<li><a
											href="javascript:contentLoad('출석시험 시험지풀관리','/admin/quiz/quizPoolList', {'quizType' : '1'});">출석시험
												시험지풀관리</a></li>
										<li><a
											href="javascript:contentLoad('기수/과정별 출석시험 관리','/admin/quiz/quizList', {'quizType' : '1'});">기수/과정별
												출석시험 관리</a></li>
										<li><a
											href="javascript:contentLoad('기수/과정별 출석시험 현황','/admin/quiz/quizAppList', {'quizType' : '1'});">기수/과정별
												출석시험 현황</a></li>
										<li><a
											href="javascript:contentLoad('출석시험 고사장 관리','/admin/quiz/examSpotList');">출석시험
												고사장 관리</a></li>
										<!-- <li><a href="javascript:alert('준비중입니다.');">출석시험 관리 매뉴얼</a></li> -->
									</ul></li>
							</ul></li>
						<li><a href="javascript:void(0);">모의토플 관리</a>
							<ul class="acc_content">
								<li><a
									href="javascript:contentLoad('서비스목록 관리','/admin/toefl/toeflList');">서비스목록
										관리</a></li>
								<li><a
									href="javascript:contentLoad('개별신청관리','/admin/toefl/toeflPayList');">개별신청
										관리</a></li>
							</ul></li>
						<li><a href="javascript:void(0);">학사관리</a>
							<ul class="acc_content">
								<li><a
									href="javascript:contentLoad('성적 관리','/admin/studentManagement/studentScoreManagement');">성적
										관리</a></li>
								<!-- <li><a href="javascript:contentLoad('출석 관리','/admin/studentManagement/studentAttendanceManagement');">출석 관리</a></li> -->
								<li><a href="javascript:void(0);">설문조사관리</a>
									<ul style="display: none;">
										<li><a
											href="javascript:contentLoad('설문조사 생성','/admin/studentManagement/studentSurveyCreate');">설문조사
												생성</a></li>
										<li><a
											href="javascript:contentLoad('일반설문 내역','/admin/studentManagement/studentSurveyManagement');">일반설문
												내역</a></li>
										<li><a
											href="javascript:contentLoad('자동배포 설문','/admin/studentManagement/studentSurveyAuto');">자동배포
												설문</a></li>
									</ul></li>
								<li><a
									href="javascript:contentLoad('상담관리','/admin/studentManagement/studentCounselManagement');">상담관리</a></li>
								<li><a
									href="javascript:contentLoad('학적부 관리','/admin/studentManagement/studentTableManagement');">학적부
										관리</a></li>
							</ul></li>

						<li><a href="javascript:void(0);">이수관리</a>
							<ul class="acc_content">
								<li><a
									href="javascript:contentLoad('개별이수관리','/admin/complete/completeProc');">개별이수관리</a></li>
								<!--  
					...
					-->
						...
						<li><a href="javascript:void(0);">회원관리</a>
							<ul class="acc_content">
								<li><a
									href="javascript:contentLoad('회원관리','/admin/member/memberList');">회원관리</a></li>
								<li><a
									href="javascript:contentLoad('탈퇴회원관리','/admin/member/memOutList');">탈퇴회원관리</a></li>
								<!-- 
			...
			-->
						<li><a href="javascript:void(0);">과정/기수관리</a>
							<ul class="acc_content">
								<li><a
									href="javascript:contentLoad('분류관리','/admin/course/subCourse',{'codeGroup.id':'sub_course'});">분류관리</a></li>
								<!-- <li><a href="javascript:contentLoad('연수영역관리','/admin/course/studyRange', {'codeGroup.id':'course'});">연수영역관리</a></li> -->
								<li><a
									href="javascript:contentLoad('연수과정관리','/admin/course/trainProcessList');">연수과정관리</a></li>
								<li><a
									href="javascript:contentLoad('기수관리','/admin/course/cardinalList');">기수관리</a>
									<!--  
						<ul style="display: none;">
						...
						<li><a href="javascript:void(0);">결제관리</a>
							<ul class="acc_content">
								<li><a
									href="javascript:contentLoad('결제관리','/admin/pay/payList');">결제관리</a></li>
								<!--  
					...
					-->
								<li><a
									href="javascript:contentLoad('포인트관리','/admin/common/view/pointList');">포인트관리</a></li>
								<!--<li><a href="javascript:contentLoad('쿠폰관리','/admin/common/view/couponList');">쿠폰관리</a></li>  -->
							</ul></li>
						<li><a href="javascript:void(0);">게시물관리</a>
							<ul class="acc_content">
								<li><a
									href="javascript:contentLoad('FAQ분류 등록','/forFaith/base/code', {'codeGroup.id':'faq'});">FAQ분류
										등록</a></li>
								<!-- 					<li><a href="javascript:contentLoad('전체 공지사항','/admin/board/boardList', {'boardType':1});">전체 공지사항</a></li> -->
								<li><a
									href="javascript:contentLoad('게시판 관리','/admin/board/allBoardList');">게시판
										관리</a></li>
								<!-- 					<li><a href="javascript:contentLoad('전체 공지사항','/admin/board/noticeList');">전체 공지사항</a></li> -->
								<li><a
									href="javascript:contentLoad('과정별 공지사항','/admin/board/courseBoardList', {'boardType':1});">과정별
										공지사항</a></li>
								<!-- <li><a href="javascript:contentLoad('전체 자료실관리','/admin/board/boardList', {'boardType':2});">전체 자료실관리</a></li>-->
								<li><a
									href="javascript:contentLoad('과정별 자료실관리','/admin/board/courseBoardList', {'boardType':2});">과정별
										자료실관리</a></li>
								<!-- <li><a href="javascript:contentLoad('자유게시판 관리','/admin/board/freeBoardList', {'boardType':8});">자유게시판 관리</a></li> -->
								<li><a
									href="javascript:contentLoad('자주묻는질문','/admin/board/faqList');">FAQ
										관리</a></li>
								<li><a
									href="javascript:contentLoad('온라인 상담 관리','/admin/board/onlineConsulting');">온라인
										상담 관리</a></li>
								...
								<li><a
									href="javascript:contentLoad('과정별 질의응답관리','/admin/board/courseBoardList', {'boardType':6});">과정별
										질의응답관리</a></li>
								...
								<li><a
									href="javascript:contentLoad('연수설문관리','/admin/board/surveyList');">연수설문관리</a></li>
								<!--<li><a href="javascript:contentLoad('쪽지함관리','/admin/board/noteList');">쪽지함관리</a></li> -->
							</ul></li>
						<li><a href="javascript:void(0);">통계조회</a>
							<ul class="acc_content">
								<li><a
									href="javascript:contentLoad('기수/과정별학습통계','/admin/stats/courseStatsList');">기수/과정별학습통계</a></li>
								<!--
					...
					<li><a href="javascript:contentLoad('수강현황통계(II)','/admin/stats/learnStatsGraph');">수강현황통계(II)</a></li>
					  -->
								<li><a
									href="javascript:contentLoad('만족도 조사 통계','/admin/stats/surveyStatsList?survey.surveyCode.code=survey999');">만족도
										조사 통계</a></li>
								<!--  
					...
					-->
						...
						<li><a href="javascript:void(0);">기초관리</a>
							<ul class="acc_content">
								<!-- 
					...
					<li><a href="javascript:contentLoad('연수자 IP 관리','/admin/basic/ipList');">연수자 IP 관리</a></li>
					 -->
						...
						<li><a href="javascript:void(0);">출결관리</a>
							<ul class="acc_content">
								<li><a
									href="javascript:contentLoad('기수별출석일수관리','/admin/attendance/insertDate');">기수별출석일수관리</a></li>
								<li><a
									href="javascript:contentLoad('출결관리','/admin/attendance/attendanceCheck');">출결관리</a></li>
							</ul></li>
						<li><a href="javascript:void(0);">지원관리</a>
							<ul class="acc_content">
								<li><a
									href="javascript:contentLoad('지원자관리','/admin/studentManagement/applyManagement');">지원자관리</a></li>
							</ul></li>
						<li><a href="javascript:void(0);">SMS/메일관리</a>
							<ul class="acc_content">
								<li><a
									href="javascript:contentLoad('sms 전송결과 조회','/admin/common/smsHistory');">SMS
										전송결과 조회</a></li>
								<li><a
									href="javascript:contentLoad('메일 전송결과 조회','/admin/common/emailHistory');">메일
										전송결과 조회</a></li>
							</ul></li>
					</c:when>
					<c:when test="${loginUser.grade eq 1}">
							...
							<ul class="acc_content">
								...
								<li><a
									href="javascript:contentLoad('과정별 질의응답관리','/admin/board/courseBoardList', {'boardType':6});">과정별
										질의응답관리</a></li>
								<li><a
									href="javascript:contentLoad('연수후기관리','/admin/board/courseBoardList', {'boardType':5});">연수후기관리</a></li>
