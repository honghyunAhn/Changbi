...
$(document).ready(function () {
	...
	var selectDelUrl = "<c:url value='/data/member/memberSelectDel' />";	// 회원 선택 삭제
	var saveExcelUrl = "<c:url value='/data/member/excel/download/memberList' />";	// 회원 리스트 엑셀 다운로드
			...
			success	: function(result) {
				...
				if(result.list && result.list.length > 0) {
					...
					for(var i=0; i<dataList.length; ++i) {
						...
						sType = (dataInfo.sType == "1" ? "초등" : (dataInfo.sType == "2" ? "중등" : (dataInfo.sType == "3" ? "고등" : (dataInfo.sType == "4" ? "유아" : (dataInfo.sType == "5" ? "특수" : "기관")))));
