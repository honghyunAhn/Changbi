...
<link href="<c:url value="/resources/student/css/studentScoreManagement.css"/>"rel="stylesheet">
...
<div class="content_wraper" id="modalContents">
	...
	<dl>
		...
		<dd class="half select2_dd" id="gisuSelector">
			<select class="js-example-basic-single" name="state" id="gisuSelector" onchange="settingCat(this.value)"></select>
		 </dd>
	 </dl>
	<div id="tabs_content_container" style="padding: 0px;">
    	...
    	<div id="tab1" class="tab_content" style="display: block;">
			<div>
				<div class="panel panel-default" style="overflow-x:scroll;height: 539px;">
					...
					<!-- Table -->
					<table class="table table-hover" id="searchMemberTestTable" style="overflow-x:scroll;width: 1200px;"></table>
				</div>
				<table class="table table-hover" id="searchMemberTestTableHide" style="overflow-x:scroll;width: 1200px;display: none;visibility: hidden;"></table>
			</div>
		</div>
		<!-- 성적 입력 -->
			...
			<div>
				<div class="panel panel-default">
					...
					<div class="panel-heading">
						<label style="margin-bottom:0px;margin-left: 2%;margin-right: 1%;">시험명 : </label>
						<select class="js-example-basic-single" id="testCategory" onchange="TestListAll(this.value);" style="width: 30%;" name="state">
			...
			<div class="content d-flex">
				<div class="section d-flex" id="bigCat" style="background-color: #333333;">
					<div class="article">
						...
						<div class="progress" id="bigProgress"></div>
						<hr>
						<div class="categoryList" id="bigCL" style="background-color: #333333; height: 300px;"></div>
        			</div>
        			<div class="aside">
    			...
    			<div class="section d-flex" id="midCat" style="background-color: #666666;">
        			<div class="article">
       					...
       					<div class="progress" id="midProgress"></div>
						<hr>
						<div class="categoryList" id="midCL" style="background-color: #666666; height: 300px;"></div>
        			</div>
			        <div class="aside">
				        <div class="titlee" style="color: black">설정하기</div>
				        <hr>
				...
				<div class="section d-flex" id="smallCat" style="background-color: #888888;">
                	<div class="article">
       					...
       					<div class="progress" id="smallProgress"></div>
						<hr>
						<div class="categoryList" id="smallCL" style="background-color: #888888; height: 300px;"></div>
        			</div>
        			<div class="aside">
        				<div class="titlee" style="color: black">설정하기</div>
        				<hr>
		...
		<div id="tab6" class="tab_content">
			<div class="panel panel-default" style="margin: 10px;">
				<div class="panel-heading">
					<label style="margin-bottom:0px;margin-left: 2%;margin-right: 1%;">반 : </label>
					<select class="js-example-basic-single" id="selectClasss" onchange="selectableUser()" style="width: 25%;" name="state"></select>
					
					<label style="margin-bottom:0px;margin-left: 2%;margin-right: 1%;">이름 : </label>
					<select class="js-example-basic-single" id="selectUserInClass" onchange="selectableUser()" style="width: 25%;" name="state"></select>
				</div>
				<div style="min-height: 260px;max-height: 260px;overflow-y: auto;overflow-x:hidden;">
					<table class="table table-hover" style="margin-bottom: 0px;" id="classInfoUser"></table>
				</div>
			</div>
			...
			<div class="ccontent dd-flex">
				<div class="ssection">
					...
					<ul class="classGroup" id="classGroup"></ul>
