...
$(document).ready(function () {
	/** 변수 영역 **/
	// 여기에서 URL 변경 시켜서 사용
	var listUrl	= "<c:url value='/data/basic/infoList' />";
	var editUrl	= "<c:url value='/admin/basic/infoEdit' />";
	var excelUrl = "";
			...
			success	: function(result) {
				...
				if(result.list && result.list.length > 0) {
					...
					for(var i=0; i<dataList.length; ++i) {
						...
						sb.Append("<td class='content_edit'>"+dataInfo.themaTypeName+"</td>");
						sb.Append("<td>"+dataInfo.showStartDate+"</td>");
						sb.Append("<td>"+dataInfo.showEndDate+"</td>");
