...
$(document).ready(function() {
	// url을 여기서 변경
	var listUrl = "<c:url value='/forFaith/base/codeList' />";
	var regUrl = "<c:url value='/forFaith/base/codeReg' />";
	var delUrl = "<c:url value='/forFaith/base/codeDel' />";
 ...
 function orderNumDuplicated(){
	 var newOrderNumVal = $(":text[name='orderNum']").val();
		$(".order_num").each(function(i){
		   var nowOrderNumVal = $(".order_num").eq(i).text();		   
		   if(nowOrderNumVal == newOrderNumVal){
...
<div class="content_wraper">
	...
	<div class="tab_body">
		...
		<table style="border-collapse: collapse;">
			...
			<tbody>
			<tr>
				<td colspan="4" style="height: 10px; line-height: 10px;">&nbsp;</td>
			</tr>
			<tr>
				<td><input type='text' name='orderNum' onkeyup='orderNumDuplicated();' placeholder="순서입력"/></td>
				<td><input type='text' name='code' placeholder="분류코드 입력"/></td>
				<td><input type='text' name='name' placeholder="분류명 입력"/></td>
