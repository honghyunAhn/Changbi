...
<!-- 외부 자바스크립트 -->
<script src='/resources/js/ext/jquery/jquery-1.11.0.min.js'></script>

<script type="text/javascript">


// 에디터 업로드 호출
function editorUpload(fileData, sUploadURL) {
    ...
    jQuery.ajax({
        ...
        processData : false,
        contentType : false,
        success     : function(naverEditor) {
            makeArrayFromString("&bNewLine="+naverEditor.bNewLine+"&sFileName="+naverEditor.sFileNmae+"&sFileURL="+naverEditor.sFileURL+"&callback_func="+naverEditor.callbackFunc);
        },
...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
    	<!-- content -->
		<form id="editor_upimage" name="editor_upimage" action="" method="post" enctype="multipart/form-data" onSubmit="return false;">
        <div id="pop_content2">
